...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\594234048\MyApp\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>MyApp</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-item>\n    <ion-label floating >ชื่อผู้ใช้</ion-label>\n    <ion-input type="text" [(ngModel)]="username"></ion-input>\n  </ion-item>\n  <ion-item>\n    <ion-label floating >รหัสผ่าน</ion-label>\n    <ion-input type="password" [(ngModel)]="password"></ion-input>\n  </ion-item>\n  <button ion-button block (click)="signIn(username,password)" ><ion-icon name="log-in"></ion-icon>&nbsp;&nbsp; เข้าสู่ระบบ</button>\n  <h3>{{loginResult}}</h3>\n</ion-content>\n'/*ion-inline-end:"D:\594234048\MyApp\src\pages\home\home.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"D:\594234048\MyApp\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"D:\594234048\MyApp\src\pages\list\list.html"*/
        }),
...
var PhoneBookPage = /** @class */ (function () {
    function PhoneBookPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.contactArray = [{ name: 'kirito', telephone: '0622107669', imageUrl: 'assets/imgs/kirito.jpg' },
    ...
    PhoneBookPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-phone-book',template:/*ion-inline-start:"D:\594234048\MyApp\src\pages\phone-book\phone-book.html"*/'<!--\n  Generated template for the PhoneBookPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n\n          <button ion-button menuToggle>\n            <ion-icon name="menu"></ion-icon>\n          </button>\n    <ion-title>PhoneBook</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-list >\n    <ion-item *ngFor="let item of contactArray" (click)="viewDetail(item)"  >\n      <h2>{{item.name}}</h2>\n      <h2>{{item.telephone}}</h2>\n      <ion-avatar item-start>\n        <img src="{{item.imageUrl}}">\n      </ion-avatar>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"D:\594234048\MyApp\src\pages\phone-book\phone-book.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], PhoneBookPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_social_info_social_info__ = __webpack_require__(99);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__pages_list_list__["a" /* ListPage */], __WEBPACK_IMPORTED_MODULE_8__pages_social_info_social_info__["a" /* SocialInfoPage */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_phone_book_phone_book__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_social_info_social_info__ = __webpack_require__(99);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        this.pages = [
            { title: 'SocialInfoPage', component: __WEBPACK_IMPORTED_MODULE_7__pages_social_info_social_info__["a" /* SocialInfoPage */], icon: 'md-finger-print' },
            { title: 'Home', component: __WEBPACK_IMPORTED_MODULE_5__pages_home_home__["a" /* HomePage */], icon: 'md-finger-print' },
            { title: 'List', component: __WEBPACK_IMPORTED_MODULE_6__pages_list_list__["a" /* ListPage */], icon: 'md-finger-print' },
            { title: 'Phonebook', component: __WEBPACK_IMPORTED_MODULE_0__pages_phone_book_phone_book__["a" /* PhoneBookPage */], icon: 'md-finger-print' }
        ];
    }
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\594234048\MyApp\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        <ion-icon name={{p.icon}}></ion-icon>\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"D:\594234048\MyApp\src\app\app.html"*/
        }),
...
var SocialInfoPage = /** @class */ (function () {
    ...
    SocialInfoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-social-info',template:/*ion-inline-start:"D:\594234048\MyApp\src\pages\social-info\social-info.html"*/'<ion-header>\n\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>เกี่ยวกับฉัน</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n\n  <ion-card>\n    <ion-item>\n      <ion-avatar item-left>\n        <img src="assets/imgs/img_song.jpg">\n      </ion-avatar>\n      <h2>Song Narongchai</h2>\n      <p>โพสเมื่อ 1 ชม.ที่แล้ว</p>\n    </ion-item>\n    <img src="assets/imgs/img_song.jpg">\n    <ion-card-content>\n      <p></p>\n    </ion-card-content>\n    <ion-row>\n      <ion-col>\n        <button ion-button icon-left clear small>\n          <ion-icon name="thumbs-up"></ion-icon>\n          <label for="">20,000,000,000,000</label>\n          <div></div>\n        </button>\n      </ion-col>\n      <ion-col>\n        <button ion-button icon-left clear small>\n          <ion-icon name="text"></ion-icon>\n          <label for="">254500000</label>\n          <div></div>\n        </button>\n      </ion-col>\n      <ion-col center text-center>\n        <ion-note>\n          \n        </ion-note>\n      </ion-col>\n    </ion-row>\n  </ion-card>\n\n\n\n\n</ion-content>'/*ion-inline-end:"D:\594234048\MyApp\src\pages\social-info\social-info.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], SocialInfoPage);
