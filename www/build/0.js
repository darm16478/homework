...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__phone_book_detail__ = __webpack_require__(274);
...
var PhoneBookDetailPage = /** @class */ (function () {
    function PhoneBookDetailPage(navCtrl, navParams) {
    ...
    PhoneBookDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-phone-book-detail',template:/*ion-inline-start:"D:\594234048\MyApp\src\pages\phone-book-detail\phone-book-detail.html"*/'<!--\n  Generated template for the PhoneBookDetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{contact.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding >\n  \n    <img src="{{contact.imageUrl}}" alt="" width="100%" height="350">\n    <br>\n    <button ion-button block round ><ion-icon ios="ios-call" md="md-call"></ion-icon>&nbsp;&nbsp;call : {{contact.telephone}}</button>\n    <button ion-button block round><ion-icon ios="ios-mail" md="md-mail"></ion-icon>&nbsp;&nbsp;SMS : {{contact.telephone}}</button>\n\n</ion-content>\n'/*ion-inline-end:"D:\594234048\MyApp\src\pages\phone-book-detail\phone-book-detail.html"*/,
        }),
